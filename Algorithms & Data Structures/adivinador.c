...
void recorrerArbol(Nodo **raiz)
{
    ...
    else
    {
        ...
        fgets(nuevaPregunta, sizeof(nuevaPregunta), stdin);
        ...
        printf("¡Gracias! Aprendi algo nuevo.\n");
    }
}
...
void main()
{
    ...
    Nodo *raiz = crearNodo("¿Es carnivoro?", 1);
    raiz->der = crearNodo("leon", 0);
    raiz->izq = crearNodo("cebra", 0);
